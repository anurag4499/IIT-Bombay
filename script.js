// Sample chemical data array (15 items as required)
let chemicalData = [
...
let selectedRow = null; // Track the selected row for move/delete functionality
...
// Select a row using the checkbox (to highlight and enable move/delete)
...
document.getElementById("addRow").addEventListener("click", () => {
  ...
  chemicalForm.reset(); // Clear the form
  isEditMode = false;
  modal.show();
});
